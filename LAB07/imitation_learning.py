...
# camada 1
model.add(layers.Dense(num_neurons1, activation=activations.linear, input_shape=(1,)))
model.add(layers.LeakyReLU(alpha))

# camada 2
model.add(layers.Dense(num_neurons2, activation=activations.linear))
model.add(layers.LeakyReLU(alpha))
# camada 3
model.add(layers.Dense(num_neurons3, activation=activations.linear))
